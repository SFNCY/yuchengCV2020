...
int main(int argc, char** argv) {
    ...
    // string desc_type = "blob";
    string match_type="knn";

    string img_file1 = "/home/yucheng/Code/1.Visual_Servoing/2.half_online/visual_servoing/data/temp_color.bmp";
    // string img_file2 = "/home/yucheng/Code/1.Visual_Servoing/2.half_online/visual_servoing/data/90.bmp";
