...
#include "xcv/xopencl_kernels_video.hpp"
...
namespace cv
{
    namespace
    {
        class yuchengSparsePyrLKOpticalFlowImpl : public SparsePyrLKOpticalFlow
        {
            struct dim3
            {
                unsigned int x, y, z;
        ...
        public:
            yuchengSparsePyrLKOpticalFlowImpl(Size winSize_ = Size(21, 21),
                                              int maxLevel_ = 3,
        ...
        private:
                              ...
                              OutputArray _status, OutputArray _err)
            {
                ...
                try
                {
                    ...
                    vx_enum termEnum = (criteria.type == TermCriteria::COUNT) ? VX_TERM_CRITERIA_ITERATIONS : (criteria.type == TermCriteria::EPS) ? VX_TERM_CRITERIA_EPSILON : VX_TERM_CRITERIA_BOTH;
        ...
        void yuchengSparsePyrLKOpticalFlowImpl::calc(InputArray _prevImg, InputArray _nextImg,
                                                     InputArray _prevPts, InputOutputArray _nextPts,
                                                     OutputArray _status, OutputArray _err)
        {
            CV_INSTRUMENT_REGION()
...
{
    return makePtr<yuchengSparsePyrLKOpticalFlowImpl>(winSize, maxLevel, crit, flags, minEigThreshold);
}
